...
export type MediaListEntryFragment = (
  { __typename?: 'MediaList' }
  & Pick<MediaList, 'id' | 'mediaId' | 'status' | 'score' | 'progress' | 'progressVolumes' | 'repeat' | 'priority' | 'private' | 'hiddenFromStatusLists' | 'customLists' | 'advancedScores' | 'notes' | 'updatedAt'>
  & { startedAt?: Maybe<(
    { __typename?: 'FuzzyDate' }
    & Pick<FuzzyDate, 'year' | 'month' | 'day'>
  )>, completedAt?: Maybe<(
    ...
    { __typename?: 'Media' }
    & Pick<Media, 'id' | 'type' | 'format' | 'status' | 'episodes' | 'volumes' | 'chapters' | 'averageScore' | 'popularity' | 'isAdult' | 'countryOfOrigin' | 'genres' | 'bannerImage'>
    & { title?: Maybe<(
      { __typename?: 'MediaTitle' }
      & Pick<MediaTitle, 'userPreferred' | 'romaji' | 'english' | 'native'>
    )>, coverImage?: Maybe<(
