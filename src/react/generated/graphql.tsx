...
export type HomeTopQueryVariables = Exact<{
  page?: Maybe<Scalars['Int']>;
  perPage?: Maybe<Scalars['Int']>;
  isAdult?: Maybe<Scalars['Boolean']>;
  format?: Maybe<Array<Maybe<MediaFormat>> | Maybe<MediaFormat>>;
...
export type HomeTrendingQueryVariables = Exact<{
  page?: Maybe<Scalars['Int']>;
  perPage?: Maybe<Scalars['Int']>;
  isAdult?: Maybe<Scalars['Boolean']>;
}>;
...
export type MediaListEntryFragment = (
  { __typename?: 'MediaList' }
  & Pick<MediaList, 'id' | 'mediaId' | 'progress' | 'status' | 'score' | 'repeat' | 'priority' | 'private' | 'hiddenFromStatusLists' | 'customLists' | 'advancedScores' | 'notes' | 'updatedAt'>
  & { startedAt?: Maybe<(
    { __typename?: 'FuzzyDate' }
    & Pick<FuzzyDate, 'year' | 'month' | 'day'>
  )>, completedAt?: Maybe<(
...
export const HomeNextSeasonDocument = gql`
    query HomeNextSeason($nextSeason: MediaSeason, $nextYear: Int, $page: Int, $perPage: Int, $isAdult: Boolean) {
...
export const HomeTopDocument = gql`
    query HomeTop($page: Int, $perPage: Int, $isAdult: Boolean, $format: [MediaFormat]) {
  top: Page(page: $page, perPage: $perPage) {
    media(sort: [SCORE_DESC], type: ANIME, isAdult: $isAdult, format_in: $format) {
      ...media
    }
  }
}
 ...
 *
 * To run a query within a React component, call `useMediaListCollectionQuery` and pass it any options that fit your needs.
 * When your component renders, `useMediaListCollectionQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 *
 * To run a query within a React component, call `useStatsAndFavouritesQuery` and pass it any options that fit your needs.
 * When your component renders, `useStatsAndFavouritesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useStatsAndFavouritesQuery({
 *   variables: {
 *      userId: // value for 'userId'
 *   },
 * });
